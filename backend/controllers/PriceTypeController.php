...
use smart\catalog\backend\filters\PriceTypeFilter;
use smart\catalog\backend\forms\PriceTypeForm;
use smart\catalog\models\PriceType;

class PriceTypeController extends BackendController
{
    /**
     * List
     * @return string
    ...
    {
        $object = new PriceType;
        $model = new PriceTypeForm;
